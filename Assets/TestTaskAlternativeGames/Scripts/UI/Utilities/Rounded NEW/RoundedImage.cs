...
[AddComponentMenu("UI/Rounded Image V2")]
[ExecuteAlways]
public class RoundedImageV2 : Image
{
    ...
    public override Material GetModifiedMaterial(Material baseMaterial)
    {
        ...
        if (_materialInstance == null || _materialInstance.shader == null ||
            _materialInstance.shader.name != "UI/RoundedImageV2")
        {
            var shader = Shader.Find("UI/RoundedImageV2");
    ...
    void Update()
    {
        if (canvasRenderer.materialCount > 0)
        {
            ...
            if (currentMat != null && currentMat.shader.name == "UI/RoundedImageV2")
            {
